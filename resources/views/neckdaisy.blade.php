        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    <img src="{{ asset('products/daisy_necks01.jpeg') }}">
                    <img src="{{ asset('products/daisy_necks02.jpeg') }}">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="right-content">
                    <h4>Daisy Necklace</h4>
                    <span class="price">Rp45.000 - Rp49.000</span>
                    <ul class="stars">
                    ...
                    <span>
                        Kalung basic auper simpel dan elegan <br>
                        Bisa di tambahkan liontin untuk mempercantik tampilan <br>
                        Bahan: titanium stell <br>
                        TITANIUM ASLI no kaleng kaleng <br>
                        Besar kalung 3mm <br>
                        Banjang kalung45cm (basic) <br>
                        50cm <br>
                        60cm (Rekomendasi untuk yang memakai kerudung)
                    </span>
                    <br>
                    <div class="total">
                        <div class="main-border-button">
                            <a href="https://shopee.co.id/bestqualityy.in/10691519115">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
