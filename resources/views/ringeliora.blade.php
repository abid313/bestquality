        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    <img src="{{ asset('products/eliora_rings01.jpeg') }}">
                    <img src="{{ asset('products/eliora_rings02.jpeg') }}">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="right-content">
                    <h4>Eliora Ring</h4>
                    <span class="price">Rp13.153 - Rp16.999</span>
                    <ul class="stars">
                    ...
                    <span>
                        Material : resin <br>Ukuran : diameter 9cm 
                    </span>
                    <br>
                    <div class="total">
                        <div class="main-border-button">
                            <a href="https://shopee.co.id/bestqualityy.in/10224910694">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
