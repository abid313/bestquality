        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    <img src="{{ asset('products/dandelion_necks01.jpeg') }}">
                    <img src="{{ asset('products/dandelion_necks02.jpeg') }}">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="right-content">
                    ...
                    <div class="total">
                        <div class="main-border-button">
                            <a href="https://shopee.co.id/bestqualityy.in/7479457205">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
