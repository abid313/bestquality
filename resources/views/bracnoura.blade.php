        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    <img src="{{ asset('products/noura_bracs01.jpeg') }}">
                    <img src="{{ asset('products/noura_bracs02.jpeg') }}">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="right-content">
                    <h4>Noura Bracelet</h4>
                    <span class="price">Rp78.000</span>
                    <ul class="stars">
                    ...
                    <span>
                        Bahan titanium asli <br>
                        ANTI KARAT <br>
                        ANTI LUNTUR <br>
                        TIDAK MENIMBULKAN ALERGI/iritasi pada kulit
                    </span>
                    <br>
                    <div class="total">
                        <div class="main-border-button">
                            <a href="https://shopee.co.id/bestqualityy.in/14869256963">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
