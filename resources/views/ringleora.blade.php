        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    <img src="{{ asset('products/leora_rings01.jpeg') }}">
                    <img src="{{ asset('products/leora_rings02.jpeg') }}">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="right-content">
                    <h4>Leora Ring</h4>
                    <span class="price">Rp15.700 - Rp18.700</span>
                    <ul class="stars">
                    ...
                    <div class="total">
                        <div class="main-border-button">
                            <a href="https://shopee.co.id/bestqualityy.in/7397125183">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
