        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    <img src="{{ asset('products/emma_bracs01.jpeg') }}">
                    <img src="{{ asset('products/emma_bracs02.jpeg') }}">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="right-content">
                    <h4>Emma Bracelet</h4>
                    <span class="price">Rp39.000 - Rp43.000</span>
                    <ul class="stars">
                    ...
                    <div class="total">
                        <div class="main-border-button">
                            <a href="https://shopee.co.id/bestqualityy.in/17237047611">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
