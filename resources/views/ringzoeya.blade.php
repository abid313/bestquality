        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    <img src="{{ asset('products/zoeya_rings01.jpeg') }}">
                    <img src="{{ asset('products/zoeya_rings02.jpeg') }}">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="right-content">
                    <h4>Zoeya Ring</h4>
                    <span class="price">Rp15.890 - Rp19.800</span>
                    <ul class="stars">
                    ...
                    <div class="total">
                        <div class="main-border-button">
                            <a href="https://shopee.co.id/bestqualityy.in/8989037800">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
