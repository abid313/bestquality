...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/css/templatemo-hexashop.css') }}">
...
-->
    ...
    <script src="{{ asset('public/assets/js/accordions.js') }}"></script>
    ...
    <script src="{{ asset('public/assets/js/quantity.js') }}"></script>
