        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    <img src="{{ asset('products/qiana_necks01.jpeg') }}">
                    <img src="{{ asset('products/qiana_necks02.jpeg') }}">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="right-content">
                    <h4>Qiana Necklace</h4>
                    <span class="price">Rp89.000</span>
                    <ul class="stars">
                    ...
                    <span>
                        Material dari titanium steel 316L. <br>
                        Titanium dan stainless steel adalah aksesoris terbaik Fashion di kelasnya karena paling awet dan bagus. <br>
                        Anti karat <br>
                        anti luntur <br>
                    ...
                    <div class="total">
                        <div class="main-border-button">
                            <a href="https://shopee.co.id/bestqualityy.in/16037055255">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
